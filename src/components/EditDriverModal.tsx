...
import { editDriver } from '@/app/dashboard/drivers/actions';
...
export default function EditDriverModal({ isOpen, onClose, driver }: EditDriverModalProps) {
  ...
  useEffect(() => {
    if (driver) {
      ...
      const formattedDate = driver.license_expiry 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append('firstName', formData.first_name);
      submitData.append('lastName', formData.last_name);
      submitData.append('licenseNumber', formData.license_number);
      submitData.append('licenseExpiry', formData.license_expiry);
      submitData.append('contactNumber', formData.contact_number || '');
      submitData.append('email', formData.email || '');
      submitData.append('status', formData.status);
      
      await editDriver(submitData);
      onClose();
    } catch (err) {
