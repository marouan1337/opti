...
export default function ReportsClient({ reports }: ReportsClientProps) {
  ...
  // Handle creating a custom report
      ...
      <div className="flex flex-col md:flex-row justify-between mb-6 space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-2 items-center">
          ...
          <Link
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 whitespace-nowrap"
          >
